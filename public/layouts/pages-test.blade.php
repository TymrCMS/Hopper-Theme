...
<html lang="{{ app()->getLocale() }}">
	...
	<body class="hold-transition skin-blue-light layout-boxed sidebar-mini">
		...
		<!-- jQuery 2.2.3 -->
		<script src="{{ asset('themes/hopper/js/AdminLTE/plugins/jQuery/jquery-2.2.3.min.js') }}"></script>

		<!-- Bootstrap 3.3.6 -->
		<script src="{{ asset('themes/hopper/js/AdminLTE/plugins/bootstrap/bootstrap.3.3.7.min.js') }}"></script>

		<!-- SlimScroll -->
		<script src="{{ asset('themes/hopper/js/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js') }}"></script>

		<!-- FastClick -->
		<script src="{{ asset('themes/hopper/js/AdminLTE/plugins/fastclick/fastclick.js') }}"></script>

		<!-- AdminLTE App -->
		<script src="{{ asset('themes/hopper/js/AdminLTE/app.js') }}"></script>

		<!-- Connect the FrontEnd with the Server -->
		<script src="{{ asset('themes/hopper/js/AdminLTE/connecter.js') }}"></script>
